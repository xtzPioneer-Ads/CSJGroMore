...
extern NSString *const IsExpressAd;
extern NSString *const NormalVertical;
extern NSString *const NormalHorizontal;
extern NSString *const ExpressVertical;
extern NSString *const ExpressHorizontal;
...
extern NSString *const CustomBotomSplash;
extern NSString *const NormalAd;
extern NSString *const OriginLoadAd;
