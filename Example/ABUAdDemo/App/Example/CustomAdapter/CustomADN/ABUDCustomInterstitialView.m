...
@interface ABUDCustomInterstitialView ()
...
@implementation ABUDCustomInterstitialView

+ (instancetype)interstitialViewWithSize:(CGSize)size {
    CGRect frame = CGRectMake(0, 0, size.width, size.height);
    ABUDCustomInterstitialView *view = [[ABUDCustomInterstitialView alloc] initWithFrame:frame];
    [view setupView];
    return view;
}
