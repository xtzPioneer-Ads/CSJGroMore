...
@interface ABUDCustomRewardedVideoView ()
...
@implementation ABUDCustomRewardedVideoView

+ (instancetype)fullscreenView {
    ABUDCustomRewardedVideoView *view = [[ABUDCustomRewardedVideoView alloc] initWithFrame:[UIScreen mainScreen].bounds];
    [view setupView];
    return view;
}
