...
@interface ABUDCustomFullscreenView ()
...
@implementation ABUDCustomFullscreenView

+ (instancetype)fullscreenView {
    ABUDCustomFullscreenView *view = [[ABUDCustomFullscreenView alloc] initWithFrame:[UIScreen mainScreen].bounds];
    [view setupView];
    return view;
}
...
- (void)setupView {
    ...
    self.contentLabel.text = @"自定义全屏视频广告展示";
